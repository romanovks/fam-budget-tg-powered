...
CATEGORY_KEYWORDS: list[tuple[tuple[str, ...], tuple[str, str]]] = [
    ...
    (("carrefour", "карефур", "biedronka", "бедронка", "lidl", "aldi", "алди", "auchan", "ашан"), ("Groceries", "Supermarket")),
    (("zabka", "żabka", "жабка"), ("Groceries", "Convenience store")),
    (("action", "household chemicals", "бытовая химия", "побутова хімія"), ("Groceries", "Household supplies")),
    ...
    (("good lood", "морозиво", "мороженое", "ice cream", "lodziarnia"), ("Restaurants", "Cafe")),
    ...
    (("orlen", "shell", "bp", "fuel", "бензин", "paliwo", "топливо", "пальне"), ("Transport", "Fuel")),
    ...
    (("doctor", "врач", "лікар", "лекар", "medicine", "аптека", "pharmacy", "psychologist", "психолог"), ("Health", "Doctor")),
    (("dent", "стоматолог"), ("Health", "Dental")),
    (("kids & co", "kids and co", "садик", "садок", "детский сад", "дитячий сад", "kindergarten", "przedszkole"), ("Child", "Education")),
    (("smyk", "смик"), ("Child", "Toys")),
    (("flight", "flights", "airfare", "билет на самолет", "билеты на самолет", "квитки на літак", "авіаквитки"), ("Travel", "Flights")),
    (("car rental", "rent a car", "оренда авто", "аренда авто"), ("Travel", "Car rental")),
    (("dm", "rossmann", "hebe", "cosmetics", "косметик", "прокладки", "pads"), ("Shopping", "Cosmetics")),
    (("h&m", "hm", "zara", "clothes", "одежда", "одяг"), ("Shopping", "Clothes")),
    (("empik", "емпік"), ("Entertainment", "Books")),
    (("pet store", "зоомагазин", "zoo sklep", "zoologiczny"), ("Shopping", "Home goods")),
    (("flowers", "квіти", "цветы"), ("Shopping", "Home goods")),
    (("prom.ua", "картридж", "cartridge"), ("Shopping", "Home goods")),
    (("netflix", "youtube", "київстар тб", "киевстар тв", "mobile tv"), ("Subscriptions", "Streaming")),
    (("openai", "api balance", "cloud service"), ("Subscriptions", "Cloud services")),
